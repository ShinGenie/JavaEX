	...
	public class GawiByBo {
		...
		public static void main(String[] args) {
			...
			while(true){
				...
				switch(user){
				case 1:{System.out.println("user님은 가위입니다");}break;
				case 2:{System.out.println("user님은 바위입니다");}break;
				case 3:{System.out.println("user님은 보입니다");}break;
				case 0:{System.exit(0);}break;
				}
				
				switch(com){
				case 1:{System.out.println("com님은 가위입니다");}break;
